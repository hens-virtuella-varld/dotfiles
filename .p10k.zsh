# Generated by Powerlevel10k configuration wizard on 2024-05-07 at 09:07 CST.
# Based on romkatv/powerlevel10k/config/p10k-pure.zsh, checksum 35142.
# Wizard options: compatible, pure, snazzy, 24h time, 2 lines, compact,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%B%F{$magenta}%n%F{$red}@%m%F{$yellow}"
